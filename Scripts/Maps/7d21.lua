evt.Map[1000] = function()
	if not mapvars.ambush then
		if Party.X>-1183 and Party.X<526 and Party.Y>10342 and Party.Y<12144 then
			...
			pseudoSpawnpoint{monster = 412,  x = -3723, y = 9579, z = 1, count = 5, powerChances = {70, 30, 0}, radius = 256, group = 1,transform = function(mon) mon.ShowOnMap = true end}
		end
	end
end
...
evt.Map[1001] = function()
	if mapvars.ambush and not mapvars.ambush2 then
		if Party.X>-5321 and Party.X<-4316 and Party.Y>8514 and Party.Y<9882 then
			...
			pseudoSpawnpoint{monster = 412,  x = -6396, y = 6862, z = 1, count = 7, powerChances = {70, 30, 0}, radius = 256, group = 1, transform = function(mon) mon.ShowOnMap = true end}
