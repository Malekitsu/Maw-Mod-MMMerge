...
function events.CalcDamageToMonster(t)
	...
	--luck/accuracy bonus
	if data and data.Player and (t.DamageKind==4 or (data and data.Object and data.Object.Spell==133 and data.Item and data.Item.Bonus2==3)) then
		if data.Object==nil or data.Object.Spell==133 then
			...
			if data and data.Object and data.Object.Spell==133 and data.Object.Item and data.Object.Item.Bonus2==3 then
				t.Result=t.Result*0.25 -- as this even is called twice, actual damage is 50%
			end
		end
	end
end
