...
function events.GameInitialized2()
	...
	Game.SkillDesGM[const.Skills.Axe]=string.format("%s 1%% to halve AC and increases critical strike damage by 1%% per skill point",Game.SkillDesGM[const.Skills.Axe])
