...
function events.GameInitialized2()
	...
	Game.SkillDesGM[const.Skills.Spear]=string.format("%s each attack reduces monster phys resistance by 2, multiplied by your base weapon speed",Game.SkillDesGM[const.Skills.Spear])
