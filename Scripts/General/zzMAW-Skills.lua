...
function MawRegen()
	...
	for i=0,Party.High do
		pl=Party[i]
		local Cond = pl:GetMainCondition()
		if (Cond == 18 or Cond == 17 or Cond < 14) and pl.Insane==0 and (not vars.MAWSETTINGS.buffRework=="ON" or type(vars.currentManaPool and vars.currentManaPool[i])=="number") then
