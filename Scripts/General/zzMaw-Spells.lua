...
CCMAP={
	...
	[const.Spells.Berserk]=	{["Duration"]=const.Minute*1, ["ChanceMult"]=0.02, ["BaseCost"]=1, ["ScalingCost"]=3, ["School"]=const.Skills.Mind, ["DamageKind"]=const.Damage.Mind, ["Debuff"]=const.MonsterBuff.Berserk},
	[const.Spells.MassFear]={["Duration"]=const.Minute*6, ["ChanceMult"]=0.1, ["BaseCost"]=1, ["ScalingCost"]=0.5, ["School"]=const.Skills.Mind, ["DamageKind"]=const.Damage.Mind, ["Debuff"]=const.MonsterBuff.Fear},
