...
CCMAP={
	...
	[const.Spells.Berserk]=	{["Duration"]=const.Minute*2, ["ChanceMult"]=0.02, ["BaseCost"]=1, ["ScalingCost"]=1, ["School"]=const.Skills.Mind, ["DamageKind"]=const.Damage.Mind, ["Debuff"]=const.MonsterBuff.Berserk},
