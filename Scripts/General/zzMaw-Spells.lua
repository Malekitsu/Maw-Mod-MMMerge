...
aoespells = {6, 7, 8, 9, 10, 15, 22, 26, 32, 41, 43, 84, 93, 97, 98, 99, 123}
function events.CalcSpellDamage(t)
	data=WhoHitMonster()
...
function events.GameInitialized2()
	...
	spellPowers =
		{
			[2] = {dmgAdd =7, diceMin = 1, diceMax = 1, },--fire bolt
			[6] = {dmgAdd = 0, diceMin = 1, diceMax = 8, },--fireball
			[7] = {dmgAdd = 10, diceMin = 1, diceMax = 2, },--fire spike, the only spell with damage depending on mastery, fix in events.calcspelldamage
			[8] = {dmgAdd = 10, diceMin = 1, diceMax = 6, },--immolation
